...
from craps.strategies.field_bet import FieldBetStrategy  # Import FieldBetStrategy
...
def main():
    ...
    stats = Statistics(table_minimum, num_shooters=10, num_players=4)  # Increase num_players to 4
    ...
    players = [
        ...
        Shooter("1x Odds", initial_balance=initial_bankroll, betting_strategy=PassLineOddsStrategy(table, 1)),
        Shooter("44 Inside", initial_balance=initial_bankroll, betting_strategy=PlaceBetStrategy(table, "across")),
        Shooter("Field Bet", initial_balance=initial_bankroll, betting_strategy=FieldBetStrategy(min_bet=table_minimum))
    ]
